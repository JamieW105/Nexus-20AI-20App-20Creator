    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link to="/dashboard" className="text-cosmic-white hover:text-cosmic-cyan transition-colors">
                Dashboard
              </Link>
              <a href="#" className="text-cosmic-white/70 hover:text-cosmic-white transition-colors">
                Templates
              </a>
              <a href="#" className="text-cosmic-white/70 hover:text-cosmic-white transition-colors">
                Integrations
          ...
          <div className="flex items-center space-x-4">
            <Button variant="ghost" size="icon" className="text-cosmic-white hover:bg-cosmic-purple/20">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          {[
            { label: "Total Projects", value: "12", icon: <Folder className="w-6 h-6" />, color: "cyan" },
            { label: "Active Projects", value: "8", icon: <Code className="w-6 h-6" />, color: "purple" },
            { label: "Deployed", value: "6", icon: <Globe className="w-6 h-6" />, color: "green" },
            { label: "Total Views", value: "2.9k", icon: <TrendingUp className="w-6 h-6" />, color: "lavender" }
          ].map((stat, index) => (
            <div key={stat.label} className="glass-purple rounded-2xl p-6 cosmic-hover">
              <div className="flex items-center justify-between mb-4">
                <div className={`p-3 rounded-xl ${
                  stat.color === 'cyan' ? 'bg-cosmic-cyan/20 text-cosmic-cyan' :
                  stat.color === 'purple' ? 'bg-cosmic-purple/20 text-cosmic-purple' :
              ...
              <div className="text-cosmic-white/70 text-sm">
                {stat.label}
              </div>
            </div>
          ))}
        ...
        <div className="glass-purple rounded-2xl p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-lg font-semibold text-cosmic-white">Plan Usage</h3>
              <p className="text-cosmic-white/70 text-sm">Free Plan - 1 of 1 sites used</p>
            </div>
            <Button variant="outline" className="border-cosmic-purple text-cosmic-white hover:bg-cosmic-purple/20">
              Upgrade Plan
            </Button>
          </div>
          <div className="w-full bg-cosmic-slate/50 rounded-full h-2">
            <div className="bg-gradient-cosmic h-2 rounded-full" style={{ width: "100%" }}></div>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-cosmic-white">Your Projects</h2>
          ...
          {filteredProjects.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-cosmic-white/70">No projects found matching your search.</p>
            </div>
          ) : (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProjects.map((project) => (
                <div key={project.id} className="glass-purple rounded-2xl overflow-hidden cosmic-hover group">
                  {/* Project Image */}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex space-x-2">
                      <Link to={`/builder/${project.id}`} className="flex-1">
                        <Button variant="outline" size="sm" className="w-full border-cosmic-purple/30 text-cosmic-white hover:bg-cosmic-purple/20">
                          <Edit3 className="w-4 h-4 mr-2" />
                          Edit
                        </Button>
                      </Link>
                      <Button variant="outline" size="sm" className="border-cosmic-purple/30 text-cosmic-white hover:bg-cosmic-purple/20">
              ...
              <Link to="/builder">
                <div className="glass border-2 border-dashed border-cosmic-purple/30 rounded-2xl h-full min-h-[320px] flex flex-col items-center justify-center cosmic-hover group">
                  ...
                  <h3 className="text-lg font-semibold text-cosmic-white mb-2">Create New Project</h3>
